...
if(isset($_POST['Edit'])) {
    ...
    $sql = "UPDATE tblproduk SET gambar1='$gambar1', namaproduk1='$namaproduk1', harga1='$harga1', stock='$stock'  WHERE id='$id'";
...
<tr>
<td colspan="2"><center>Edit Produk</center></td>
</tr>
<tr>
...
<tr>
<td>Produk</td> <td><input type="file"  name="gambar1" value="<?php 
echo $gambar1;?>"></td>
</tr>
<tr>
<td>Nama Produk</td> <td><input type="text" name="namaproduk1" value="<?php echo
$namaproduk1;?>"></td>
</tr>
<tr>
<td>Harga</td> <td><input type="text" name="harga1" value="<?php echo
$harga1;?>"></td>
</tr>
<tr>
<td>Stock</td> <td><input type="text" name="stock" value="<?php echo
$stock;?>"></td>
</tr>
<tr>
<td colspan="2">
