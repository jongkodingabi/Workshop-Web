...
        </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Icon</h1>
                    <a class="bttn" href="tambahicon.php" style="color: white;">New</a>
                        <!--laporan Produk-->
    ...
    ?>
        <tbody>
         <tr class="active-row">
            ...
            <td><img style="border-radius:15px" src="/bengkel/gambar/<?php echo $row["icon"];?>"></td>
            <td><?php echo $row["judul"];?></td>
            <td><?php echo $row["why"];?></td>
            <td colspan="2">
        <a href="hapusicon.php?id=<?php echo $row["id"];?>" onclick="return confirm('Are you sure you want to delete this item?');">
  ...
  >
    ...
    <path d="M21 6V29" stroke="white" stroke-width="4"></path>
        ...
        <a href="editicon.php?id=<?php echo $row["id"];?>">
