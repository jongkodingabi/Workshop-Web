...
<body>
<form action="simpan_servis.php" method="post">
<br><br>
<center>
<table border="0" cellspacing="0" cellpadding="5">
<tr>
<td colspan="2"><center>Tambah Servis</center></td>
</tr>
<tr>
 <td>Gambar</td> <td><input type="file" name="gambar1"></td>
</tr>
<tr>
 <td>Servis</td> <td><input type="text" name="judul"></td>
</tr>
<tr>
 <td>Keterangan</td> <td><input type="text" name="subjudul"></td>
</tr>
<tr>
 <td colspan="2">
 <center>
