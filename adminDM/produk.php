        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <a class="bttn" href="tambahproduk.php" style="color: white;">New</a>
                        <!--laporan Produk-->
    ...
    ?>
        <tbody>
         <tr class="active-row">
            ...
            <td><?php echo $row["namaproduk1"];?></td>
            <td><?php echo $row["harga1"];?></td>
            <td><?php echo $row["stock"];?></td>
            <td><?php echo $row["deskripsi"];?></td>
            <td colspan="2">
        <a href="hapusproduk.php?id=<?php echo $row["id"];?>" onclick="return confirm('Are you sure you want to delete this item?');">
