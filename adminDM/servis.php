...
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800">Daftar Servis</h1>
<a class="bttn" href="tambah_servis.php" style="color: white;">New</a>
    <!--laporan Produk-->
...
<tr class="active-row">
    ...
    <td><img width="100" style="border-radius:15px" src="/bengkel/gambar/<?php echo $row["gambar1"];?>"></td>
    <td><?php echo $row["judul"];?></td>
    <td><?php echo $row["subjudul"];?></td>
    <td colspan="2">
    <a href="hapus_servis.php?id=<?php echo $row["id"];?>" onclick="return confirm('Are you sure you want to delete this item?');">
...
<a href="edit_servis.php?id=<?php echo $row["id"];?>">
