    ...
    <div id="wrapper">
         ...
         <ul class="navbar-nav bg-warning sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <img width="50px;" height="50px;" src="../gambar/logodanielmotor.jpg" />
                </div>
            </a>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Welcome,back</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Hi  <?=$_SESSION['name']?></div>
                                        </div>
                                        <div class="col-auto">
                                           <img width="40px;" height="40px;" src="/bengkel/gambar/logodanielmotor.jpg"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <?php
                                            ...
                                            $sql = "SELECT COUNT(*) as total FROM tblproduk";
                                            $result = $conn->query($sql);

                                            if ($result->num_rows > 0) {
                                            // Output data dari setiap baris
                                             while($row = $result->fetch_assoc()) {
                                             echo $row["total"] . " produk";
                                            }
                                            } else {
                                             echo "0 hasil";
                                        }
                                    ?>
                                        ...
                                        <div class="col-auto">
                                            <img src="/bengkel/gambar/produk.svg" width="40px" height="40px" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <?php
                                            // Query untuk menghitung jumlah data dalam tabel
                                            $sql = "SELECT COUNT(*) as total FROM tblservis";
                                            $result = $conn->query($sql);

                                            if ($result->num_rows > 0) {
                                            // Output data dari setiap baris
                                             while($row = $result->fetch_assoc()) {
                                             echo $row["total"] . " servis";
                                            }
                                            } else {
                                             echo "0 hasil";
                                        }
                                    ?>
                                        ...
                                        <div class="col-auto">
                                            <img src="/bengkel/gambar/service.svg" width="40px" height="40px" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Total Produk Mobil</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        <?php
                                            // Query untuk menghitung jumlah data dalam tabel
                                            $sql = "SELECT COUNT(*) as total FROM tblprodukmobil";
                                            $result = $conn->query($sql);

                                            if ($result->num_rows > 0) {
                                            // Output data dari setiap baris
                                             while($row = $result->fetch_assoc()) {
                                             echo $row["total"] . " Produk Mobil";
                                            }
                                            } else {
                                             echo "0 hasil";
                                        }
                                    ?>
                                        ...
                                        <div class="col-auto">
                                            <img src="/bengkel/gambar/produk-mobil.svg" width="40px" height="40px" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php
                                            // Query untuk menghitung jumlah data dalam tabel
                                            $sql = "SELECT COUNT(*) as total FROM tblulasan";
                                            $result = $conn->query($sql);

                                            if ($result->num_rows > 0) {
                                            // Output data dari setiap baris
                                             while($row = $result->fetch_assoc()) {
                                             echo $row["total"] . " ulasan";
                                            }
                                            } else {
                                             echo "0 hasil";
                                        }
