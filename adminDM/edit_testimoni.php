...
$sql = "SELECT * FROM tbltestimoni WHERE id='$id'";
...
if(isset($_POST['Edit'])) {
    ...
    $sql = "UPDATE tbltestimoni SET gambar='$gambar',  nama='$nama', ulasan='$ulasan'  WHERE id='$id'";
    ...
    echo '<script language="javascript">';
    echo 'window.location.href ="testimoni.php"';
    echo '</script>';
}
?>
...
<tr>
<td colspan="2"><center>Edit Testimoni</center></td>
</tr>
<tr>
...
<tr>
<td>Gambar</td>
<td><input type="file"  name="gambar" value="<?php 
echo $gambar;?>"></td></button>
</tr>
<tr>
...
<tr>
<td>Ulasan</td>
<td><textarea type="text" name="ulasan"><?php echo $ulasan;?></textarea></td>
</tr>
<tr>
<td colspan="2">
<center>
