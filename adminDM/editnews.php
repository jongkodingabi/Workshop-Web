...
if(isset($_POST['Edit'])) {
    ...
    $sql = "UPDATE tblnews SET judul='$judul', isi='$isi' WHERE id='$id'";
...
<tr>
<td colspan="2"><center>Edit News</center></td>
</tr>
<tr>
...
<tr>
<td>Judul</td> <td><input type="text"  name="judul" value="<?php 
echo $judul;?>"></td>
</tr>
<tr>
<td>Isi</td>
<td><textarea type="text" name="isi"><?php echo $isi;?></textarea></td>
</tr>
<tr>
<td colspan="2">
<center>
