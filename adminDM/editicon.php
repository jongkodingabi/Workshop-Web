...
$sql = "SELECT * FROM tblwhy WHERE id='$id'";
...
if(isset($_POST['Edit'])) {
    ...
    $sql = "UPDATE tblwhy SET icon='$icon', judul='$judul', why='$why'  WHERE id='$id'";
...
<tr>
<td colspan="2"><center>Edit Section</center></td>
</tr>
<tr>
...
<tr>
<td>Icon</td>
<td><input type="file"  name="icon" value="<?php 
echo $icon;?>"></td></button>
</tr>
<tr>
...
<tr>
<td>Text</td>
<td><textarea type="text" name="why"><?php echo $why;?></textarea></td>
</tr>
<tr>
<td colspan="2">
<center>
