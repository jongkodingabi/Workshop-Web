...
<body>
<form action="simpanicon.php" method="post">
<br><br>
<center>
<table border="0" cellspacing="0" cellpadding="5">
<tr>
<td colspan="2"><center>Tambah Icon</center></td>
</tr>
<tr>
 <td>Icon</td> <td><input type="file" name="icon"></td>
</tr>
<tr>
 <td>Judul</td> <td><input type="text" name="judul"></td>
</tr>
<tr>
 <td>Text</td> <td><input type="text" name="why"></td>
</tr>
<tr>
 <td colspan="2">
 <center>
