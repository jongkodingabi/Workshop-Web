...
        </li>
    ...
    <table class="reviews-table">
      ...
      <?php
        $sql="SELECT * FROM histori_pembelian";
        $result_per_page = 5;
      ...
      <tbody>
        <tr>
          ...
          <td>
          <a href="hapus_historipembelian.php?id=<?php echo $row["id"];?>" onclick="return confirm('Are you sure you want to delete this item?');">
    ...
    <div class="pagination">
        <?php
            for ($page=1;$page<=$number_of_pages;$page++) {
                echo '<a href="histori_pembelian.php?page=' . $page . '">' . $page . '</a> ';
            }
        ?>
    </div>
</div>
