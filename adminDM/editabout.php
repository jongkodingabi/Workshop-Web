...
<link href="css/formedit1.css" rel="stylesheet" type="text/css">
    <?php
include "koneksi.php";
...
$sql = "SELECT * FROM tbltentang WHERE id='$id'";
...
if(isset($_POST['Edit'])) {
    ...
    $sql = "UPDATE tbltentang SET gambar='$gambar', judul='$judul', subjudul='$subjudul', tentang='$tentang'  WHERE id='$id'";
...
<tr>
<td colspan="2"><center>Edit About</center></td>
</tr>
<tr>
...
<tr>
<td>Gambar</td> <td><input type="file"  name="gambar" value="<?php 
echo $gambar;?>"></td>
</tr>
<tr>
<td>Judul</td> <td><input type="text" name="judul" value="<?php echo
$judul;?>"></td>
</tr>
<tr>
<td>subjudul</td> <td><input type="text" name="subjudul" value="<?php echo
$subjudul;?>"></td>
</tr>
<tr>
<td>Tentang</td>
<td><textarea type="text" name="tentang"><?php echo $tentang;?></textarea></td>
</tr>
<tr>
<td colspan="2">
<center>
