...
$sql = "SELECT * FROM tblservis WHERE id='$id'";
...
if(isset($_POST['Edit'])) {
    ...
    $sql = "UPDATE tblservis SET gambar1='$gambar1', judul='$judul', subjudul='$subjudul'  WHERE id='$id'";
...
<tr>
<td colspan="2"><center>Edit Servis</center></td>
</tr>
<tr>
...
<tr>
<td>Gambar</td>
<td><input type="file"  name="gambar1" value="<?php 
echo $gambar1;?>"></td></button>
</tr>
<tr>
...
<tr>
<td>Keterangan</td>
<td><textarea type="text" name="subjudul"><?php echo $subjudul;?></textarea></td>
</tr>
<tr>
<td colspan="2">
<center>
